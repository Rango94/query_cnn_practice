...
def train(minist):
    x=tf.placeholder(tf.float32, [None, query_cnn_infernece.IMAGE_SIZE, query_cnn_infernece.IMAGE_SIZE, query_cnn_infernece.NUM_CHANNELS], name='x-input')
    ...
    with tf.Session() as sess:
        ...
        for i in range(TRAINING_STEPS):
            ...
            xs=tf.reshape(xs, [BATCH_SIZE, query_cnn_infernece.IMAGE_SIZE, query_cnn_infernece.IMAGE_SIZE, query_cnn_infernece.NUM_CHANNELS])
